    ...
    try:
        ...
        if (playerSelection == "cuphead" or playerSelection == "Cuphead"):
            ...
            if (cupheadStats == "yes") or (cupheadStats == "Yes") or (cupheadStats =="Y") or (cupheadStats == "y"):
                ...
                Game.Game.textSpeed(textSetting)
                print(Game.Game.tristanTate,"While we were in Romanian Prison over the past 6 months our cousin Luc came up with the Real World 10.0! This program is now at its truest form to help you escape the Matrix!")
                Game.Game.textSpeed(textSetting)
                ...
                Game.Game.textSpeed(textSetting)
                print(Cuphead.Cuphead.cupheadName, " *** Gets invited over to the Tate mansion ***")
                Game.Game.textSpeed(textSetting)
                ...
                Game.Game.textSpeed(textSetting)
                print(Game.Game.andrewTate,"Do it and stop being a coward like our cousin Luc sitting on the computer all day!")
                Game.Game.textSpeed(textSetting)
                ...
                Game.Game.textSpeed(textSetting)
                print(Game.Game.andrewTate,"I want to be a force of good and defeating King Dice and the Devil is all that I want, you can keep the Dice and never return it back!")
                Game.Game.textSpeed(textSetting)
        ...
        #Mugman with Statistics Option 
            ...
            if (mugmanStats == "yes") or (mugmanStats == "Yes") or (mugmanStats =="Y") or (mugmanStats == "y"):
                ...
                print("*Panic Ensues as Andrew and Tristan decide to end the Emergency meeting livestream on Rumble*")
                Game.Game.textSpeed(textSetting)
                print(Mugman.Mugman.mugmanName, " *** Gets invited over to the Tate mansion ***")
                Game.Game.textSpeed(textSetting)
                print(Game.Game.andrewTate,"I don't know what you're talking about if you think that my bald head can shoot down lasers then you are absolutely correct! ...")
                Game.Game.textSpeed(textSetting)
                print(Game.Game.andrewTate,"However, my Masseuse has gone down for vacation and my head needs a lot of polishing so that leaves you with only one option....")
                ...
                print(Game.Game.andrewTate,"Now that was way better than sparkling water!")
                Game.Game.textSpeed(textSetting)
                print(Game.Game.tristanTate,"Stop! Andrew! Are you seriously going to give this Mugman brokie the weapon of a True G!")
                Game.Game.textSpeed(textSetting)
                print(Game.Game.andrewTate, "Yes, I feel bad and he reminds me a lot of my days eating KFC and my time with Adin too, but a brokie version of himself!")
                Game.Game.textSpeed(textSetting)
                print("Andrew & Tristan (Privately): I mean you do realize that King Dice hasn't been fair enough with my casino establishments lately, he's been aiming for a 30 percent cut on our earnings and that is bad, we can't even afford to buying a new Bugatti.")
                ...
                if(number >= 2 and number <= 3):
                    print("The Two-sided Dice has Rolled",number)
                    print("Challenge is lost and",Mugman.Mugman.mugmanName,"has lost", number, "points making his strength attribute at: ", (Mugman.Mugman.strengthMugman) - number)
                elif (number >= 4 and number <= 7):
                    print(number)
                    print("Challenge is lost but",Mugman.Mugman.mugmanName,"has not lost any character attribute points, making his strength attribute the same at: ", (Mugman.Mugman.strengthMugman))
                elif (number >=8 and number <=10):
                    print(number)
                    print("Challenge is won, but",Mugman.Mugman.mugmanName,"has not lost any character attribute points, making his strength attribute the same at: ", (Mugman.Mugman.strengthMugman))
                elif (number >=11 and number <=12):
                    print(number)
                ...
                if(number >= 2 and number <= 3):
                    print("The Two-sided Dice has Rolled",number)
                    print("Challenge is lost and",Mugman.Mugman.mugmanName,"has lost", number, "points making his speed attribute at: ", (Mugman.Mugman.speedMugman) - number)
                elif (number >= 4 and number <= 7):
                    print(number)
                    print("Challenge is lost but",Mugman.Mugman.mugmanName,"has not lost any character attribute points, making his speed attribute the same at: ", (Mugman.Mugman.speedMugman))
                elif (number >=8 and number <=10):
                    print(number)
                    print("Challenge is won, but",Mugman.Mugman.mugmanName,"has not lost any character attribute points, making his speed attribute the same at: ", (Mugman.Mugman.speedMugman))
                elif (number >=11 and number <=12):
                    print(number)
                ...
                print("Phase Three: Defeat the Devil (The Quest for Wisdom)")
                Game.Game.textSpeed(textSetting)
                print(Mugman.Mugman.mugmanName, "&",Cuphead.Cuphead.cupheadName, "Teleport to the Devil!")
                Game.Game.textSpeed(textSetting)
                print(Game.Game.theDevil,"What????!")
                Game.Game.textSpeed(textSetting)
                ...
                if(number >= 2 and number <= 3):
                    print("The Two-sided Dice has Rolled",number)
                    print("Challenge is lost and",Mugman.Mugman.mugmanName,"has lost", number, "points making his wisdom attribute at: ", (Mugman.Mugman.wisdomMugman) - number)
                elif (number >= 4 and number <= 7):
                    print(number)
                    print("Challenge is lost but",Mugman.Mugman.mugmanName,"has not lost any character attribute points, making his wisdom attribute the same at: ", (Mugman.Mugman.wisdomMugman))
                elif (number >=8 and number <=10):
                    print(number)
                    print("Challenge is won, but",Mugman.Mugman.mugmanName,"has not lost any character attribute points, making his wisdom attribute the same at: ", (Mugman.Mugman.wisdomMugman))
                elif (number >=11 and number <=12):
                    print(number)
